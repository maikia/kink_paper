...
#define _style_ca	*((int*)_ppvar[1]._pvoid)
...
static void nrn_alloc(Prop* _prop) {
 ...
 nrn_promote(prop_ion, 3, 0);
 	...
 	_ppvar[1]._pvoid = (void*)(&(prop_ion->dparam[0]._i)); /* iontype for ca */
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 19, 3);
 	...
 	ivoc_help("help ?1 rel /home/maja/maja/phdProject/Brette Lab/Model DB/McCormickEtAl2007YuEtAl2008/morpho/x86_64/release.mod\n");
