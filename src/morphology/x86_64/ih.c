...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 26, 5);
 	...
 	ivoc_help("help ?1 iH /home/maja/maja/phdProject/Brette Lab/Model DB/McCormickEtAl2007YuEtAl2008/morpho/x86_64/ih.mod\n");
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 86 in file ih.mod:\n	SOLVE states METHOD euler\n"); nrn_complain(_p); abort_run(error);}
