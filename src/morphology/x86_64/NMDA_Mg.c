...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 32, 4);
 	...
 	ivoc_help("help ?1 NMDA_Mg /home/maja/maja/phdProject/Brette Lab/Model DB/McCormickEtAl2007YuEtAl2008/morpho/x86_64/NMDA_Mg.mod\n");
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 155 in file NMDA_Mg.mod:\n\n"); nrn_complain(_p); abort_run(error);}
